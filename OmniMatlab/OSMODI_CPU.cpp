...
//R03_CPU (Mar 2025) - This code is CPU only. If you have trouble with Matlab's mexcuda function, this code may be easier to get running. It will likely be slower in larger datasets, though. The code is multi-threaded by default.


//====This is a Matlab implementation using mexcuda.====
//The variables are transferred directly from Matlab memory to here.
//Compile with "mex OSMODI_CPU.cpp"
...
//(not an option) options.SolverDevice (default is 'CPU') %Not an option for CPU-only code.
